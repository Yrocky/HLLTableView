...
- (void) configureWithKnownRegions{
    ...
    for (NSString * timeZoneName in knownTimeZoneNames) {
        ...
        if (fullTimeZoneNames.count > 1) {
            ...
            HLLTimeZone * timeZoneWrapper = [[HLLTimeZone alloc] initWithTimeZone:timeZone fullTimeZoneNames:fullTimeZoneNames];
            
            [region addTimeZone:timeZoneWrapper];
        }
    }
